...
### Minutes:
- General updates: P2320 (Static Reflection) Moved forward on SG7, Pattern matching will probebly rebase on Herb's utility paper, Executors are currently on hold.
